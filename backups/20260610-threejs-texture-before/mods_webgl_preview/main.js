(function () {
  ...
  api.registerMod({
    ...
    level: 2,
    description: "現在のシーンをThree.jsでアプリ内再生します。"
  });
  ...
  api.registerUI({
    ...
    onMount(el, appApi) {
      ...
      btn.addEventListener("click", () => {
        ...
        openThreePreviewModal(scene, appApi);
      });
    }
  });
  ...
  function openThreePreviewModal(scene, appApi) {
    ...
    loadThree()
      .then(THREE => {
        ...
        activeCleanup = mountThreePreview(THREE, scene, modal);
  ...
  function mountThreePreview(THREE, data, modal) {
