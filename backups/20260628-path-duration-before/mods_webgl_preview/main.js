(function () {
  ...
  api.registerUI({
    ...
    position: "top",
    html: '<button class="tb-btn webgl-preview-btn threejs-preview-btn" id="webgl-preview-btn" title="Three.jsプレビューを開く"><i class="ti ti-cube"></i><span>Three.js</span></button><button class="tb-btn threejs-image-btn" id="three-image-btn" title="画像レイヤーを追加"><i class="ti ti-photo-plus"></i><span>画像</span></button><button class="tb-btn threejs-export-btn" id="three-export-btn" title="Three.js JSを書き出す"><i class="ti ti-file-export"></i><span>JS書出</span></button>',
    onMount(el, appApi) {
      ...
      if (!btn || !imageBtn || !exportBtn) return;
